...
class EquationHelpModel {
    ...
    let stepText = ["To start, write the numbers in a vertical column, with the number you are taking away from on top and the number you are taking away on the bottom. Ensuring the numbers line up with their place values.",
    ...
    let stepImage: [UIImage] = [UIImage(named: "subtractByBorrowingStep1")!,
